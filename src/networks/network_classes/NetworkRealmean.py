...
class NetworkRealmean(Network):
    ...
    def make_model(self):
        init_seed=100
        main_input_l = concatenate([self.input_layers['position'], self.input_layers['head'], self.input_layers['ear_left']])
        main_input_r = concatenate([self.input_layers['position'], self.input_layers['head'], self.input_layers['ear_right']])
        num_in_neurons = 0
        ...
        self.model._name = "realmean_model"
