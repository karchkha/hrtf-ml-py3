...
class NetworkMagReconR(Network):
...
#        layert_l = Dense(num_out_neurons, kernel_initializer=ki.identity(gain=1.0), activation=globalvars.custom_activation_sig, name=self.model_name+'_hidden1_l')(mag_l)
...
#        output_magrecon_l = Dense(num_out_neurons, kernel_initializer=ki.identity(gain=1.0),  activation=globalvars.custom_activation_sig, name=self.output_names[0])(layert_l)
        ...
        layert_r = Dense(num_out_neurons, kernel_initializer=ki.identity(gain=1.0),  activation=globalvars.custom_activation_sig, name=self.model_name+'_hidden1_r')(layert_r)
...
#        layert_r = Dense(3*num_in_neurons, kernel_initializer=ki.identity(gain=1.0),  activation=globalvars.custom_activation, name=self.model_name+'_hidden8_r')(layert_r)
        ...
        self.model = Model(inputs=self.input_layers.values(), outputs=[output_magrecon_r])
        self.model.name = 'magreconr_model'
